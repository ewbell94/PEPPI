...
our $hhib=$ENV{'HHLIB'};
our $execdir = $hhib."../psipred/bin";         # path to PSIPRED V2 binaries
our $datadir = $hhib."../psipred/data";        # path to PSIPRED V2 data files
our $ncbidir = $hhib."../psiblast/blast/bin";           # path to NCBI binaries (for PSIPRED in addss.pl)
#our $execdir = "/nfs/amino-home/liuzi/lz_program/TACOS/source/HHsearch/psipred/bin";  # path to PSIPRED V2 binaries
#our $datadir = "/nfs/amino-home/liuzi/lz_program/TACOS/source/HHsearch/psipred/data"; # path to PSIPRED V2 data files
#our $ncbidir = "/nfs/amino-home/liuzi/lz_program/TACOS/source/HHsearch/psiblast/blast/bin";    # path to NCBI binaries (for PSIPRED in addss.pl)
