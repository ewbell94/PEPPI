...
$user="liuzi"; # user name, please change it to your name, e.g. 'jsmith'
$outdir="/nfs/amino-home/liuzi/Task/Domain_monomer/"; #where input/output files are
$bindir="/nfs/amino-home/liuzi/Project/C-I-TASSER/version_2018_09_01"; #where script and cas programs are
$Q="urgent"; #what queue you want to use to submit your jobs
...
foreach $s(@ss){
    ...
    `mkdir -p $clusterdir`;
    `mkdir -p $recorddir`;
    $tag="CLO1$oj\_$tag1\_$s";  #unique for distinguishing jobs
    $tradir="$outdir/$s";
