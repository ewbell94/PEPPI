...
c       'closci_j.pdb'--PDB format of j-th decoy that is closest to
c                       i-th combo, closc1_1.pdb=closc1.pdb
c
...
***   select structure for clustering-------->
 ...
 61            format(f8.3,1x,f11.2,1x,i10,1x,a35)
            else
               rmsd_str(i_str)=-1
            endif
            i_str=i_str+1
...
***
 ...
 1200    format('#Cluster',i3,f8.3,i8,2x,a35)
     ...
     $           istr(m),filen(itra(m))
 1201       format(i3,i8,f7.3,1x,f7.3,1x,f11.1,1x,i8,2x,a35)
c 1201       format(i3,i8,2f7.3,1x,f9.1,i8,2x,a35)
***   E_combo:
...
***   
 ...
 124     format('Minimum RMSD in all=',f8.3,f9.1,i8,2x,a35)
 125     format('Minimum RMSD in use=',f8.3,f9.1,i8,2x,a35)
 126     format('Minimum E    in all=',f8.3,f9.1,i8,2x,a35)
 127     format('Minimum E    in use=',f8.3,f9.1,i8,2x,a35)
      endif
      write(20,*)
...
ccccccccccccccccccoutput cluster analysis cccccccccccccccccccc
     ...
     $        iden1(i),filen(iden2(i))
      enddo
 123  format(i2,i6,f6.2,f7.0,f6.2,1x,f9.1,1x,f9.1,i6,1x,a25,i6,1x,a25)
